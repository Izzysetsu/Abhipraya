...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (builderForm) {
        builderForm.addEventListener('submit', async (e) => {
            ...
            submitBtn.innerHTML = '<span class="loader" style="width: 20px; height: 20px; border-width: 2px; margin:0; display:inline-block;"></span> Memproses...';
            ...
            const newInvitation = {
                ...
                groom_photo: 'assets/groom_avatar.png', // Default avatar
                bride_name: brideName,
                bride_parent: document.getElementById('bride_parent').value,
                bride_photo: 'assets/bride_avatar.png', // Default avatar
            ...
            try {
                ...
                submitBtn.innerHTML = '✨ Generate Undangan';
